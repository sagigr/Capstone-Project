...
library(RWeka)
one-grams <- NGramTokenizer(blogsdata, Weka_control(min = 1, max = 1))
bi-grams <- NGramTokenizer(blogsdata, Weka_control(min = 2, max = 2))
tri-grams <- NGramTokenizer(blogsdata, Weka_control(min = 3, max = 3))
